export const KR = {
    ...
    PlayerTradePriceFilter: "가격 필터",
    PlayerTradeFilterBetterThanMarket: "시장가격보다 좋을 경우만",
    ...
    RandomIsland: "랜덤 아일랜드",
    RandomIslandBonus:
        "<li>이 지도는 시작할 때마다 무작위로 변경됩니다.</li><li>지도 크기, 그리드 유형, 자원 매장층과 특별 보너스는 모두 무작위 생성됩니다.</li><li>5분 쿨다운 타임이 있습니다 - 재생성은 최소 5분의 간격을 두고 일어납니다</li>",
